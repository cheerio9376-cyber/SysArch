...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$student_id || !$password) {
        ...
        $stmt = $conn->prepare("
            SELECT student_id, password, firstname, lastname, course, course_level, role 
            FROM students 
            WHERE student_id = ?
        ");
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            if (password_verify($password, $row['password'])) {
                ...
                if ($remember) {
                    setcookie("student_id", $row['student_id'], time() + 604800, "/");
                }
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container-fluid px-4">
        ...
        <div class="ms-auto d-flex align-items-center gap-3">
            ...
            <a href="#login-section" class="btn btn-pastel-yellow btn-sm px-3">
                Login
            </a>

            <a href="register.php" class="btn btn-outline-pastel-yellow btn-sm px-3">
                Register
            </a>
        </div>
                ...
                <div class="hero-content">
                    ...
                    <div>
                        ...
                        <div class="hero-text">
                            ...
                            <!-- UPDATED TEXT -->
                            <h1 class="fw-bold">
                                CCS Monitoring System
                            </h1>

                            <p class="mt-3">
                                Welcome to the monitoring system for the College of Computer Studies.
                            </p>
            ...
            <div class="col-lg-4 col-md-7 col-sm-10">
                ...
                <div class="login-card p-4 p-md-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h4 class="fw-bold" style="color:#5a3d82;">
                            Student Login
                        </h4>
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text bg-white">
                                    <i class="bi bi-person" style="color:#5a3d82;"></i>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text bg-white">
                                    <i class="bi bi-lock" style="color:#5a3d82;"></i>
                                </span>
                    ...
                    <p class="text-center mt-4 mb-0 small">
                        ...
                        <a href="register.php" style="color:#5a3d82;font-weight:600;">
                            Register here
                        </a>
...
<footer class="footer">
    ...
    <small>
        &copy; <?= date('Y') ?>
        College of Computer Studies | CCS Monitoring System
    </small>
