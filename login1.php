...
<head>
    ...
    <style>
        ...
        .footer, .main-footer { margin-top: auto; }
    </style>
</head>
<body>

<!-- NAVBAR — same Bootstrap structure as landing.php, brand only + back link -->
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container-fluid px-4">
        ...
        <div class="ms-auto d-flex align-items-center gap-3">
            <a href="index.php" class="text-white text-decoration-none d-flex align-items-center gap-1" style="font-size:13.5px;font-family:'Poppins',sans-serif;font-weight:500;opacity:.88;">
                ...
                <div class="hero-content">
                    <div>
                        ...
                        <div class="hero-text">
                            ...
                            <p class="mt-3">Welcome to the monitoring system for the College of Computer Studies.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="login-card p-4 p-md-5">
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3 d-flex justify-content-between align-items-center">
                            ...
                            <a href="forgot_password.php" class="small" style="color:#5a3d82;">Forgot Password?</a>
                        </div>
